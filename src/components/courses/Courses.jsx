  ...
  return (
    <div id="courses" className="container-custom mt-[50px]" data-aos="fade-up">
      ...
      <div className="w-full grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center gap-[30px]">
        {courses.map((e) => {
          return (
            <div key={e.id} className="rounded-xl overflow-hidden text-start flex flex-col gap-[8px] border border-[#DCDCE5] h-[500px] course-card transition" data-aos="fade-up" data-aos-duration={`${e.id}00`}>
